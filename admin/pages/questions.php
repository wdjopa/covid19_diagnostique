                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="text-right">
                                    <a  href="#!"  data-toggle="modal" data-target="#addQuestion" class="btn btn-xs btn-primary "> Ajouter une question  </a>
                                </p>
                            </div>
                            <div class="card-body">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addQuestionLabel">Nouvelle question</h5>
                <a href="#" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </a>
            </div>
            <div class="modal-body">
                <form action="#" method="post" name="questionAAjouter">
            ...
            <div class="modal-footer">
                ...
                <a href="#" onclick="addData()" data-dismiss="modal" class="btn btn-primary">Valider</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="updateQuestion" tabindex="-1" role="dialog" aria-labelledby="updateQuestionLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="#" class="btn btn-light" data-dismiss="modal">Annuler</a>
                <a href="#" onclick="saveUpdate()" data-dismiss="modal" class="btn btn-primary">Valider</a>
            </div>
        </div>
    </div>
</div>